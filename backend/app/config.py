...
class Configuracoes(BaseSettings):
    ...
    # verdade. Fica desligada por padrão porque ligá-la sem HTTPS faria o
    # cookie ser recusado silenciosamente pelo navegador, um jeito pior de
    # quebrar do que o Lax padrão.
